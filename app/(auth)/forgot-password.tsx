...
export default function ForgotPasswordScreen() {
  ...
  const handleResendCode = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        Alert.alert(
          "Email Sent",
          "A fresh recovery email has been sent to your inbox.",
        );
      }
    } catch (err: any) {
  ...
  const handleResetPassword = async () => {
    ...
    if (!trimmedCode) {
      Alert.alert(
        "Code Required",
        "Please enter the 6-digit recovery code from your email.",
      );
      return;
    }
    ...
    try {
      ...
      Alert.alert(
        "Verification Failed",
        err.message ||
          "Invalid or expired code. Please verify the code or request a new one.",
      );
    } finally {
      setVerifying(false);
    }
        ...
        {step === "email" ? (
          ...
          >
            ...
            >
              ...
              <View style={{ flex: 1, marginLeft: 10 }}>
                ...
                >
                  ...
                  Open your email on this device and tap the{" "}
                  <Text style={{ fontWeight: "700", color: colors.text }}>
                    "Reset password"
                  </Text>{" "}
                  button to set a new password instantly.
                  {"\n\n"}
                  🔢 If you received a 6-digit recovery code instead, enter it
                  below:
                </Text>
              </View>
            </View>
            ...
            <View style={styles.secondaryActions}>
              ...
              >
                <Text
                  style={[styles.changeEmailText, { color: colors.textMuted }]}
                >
                  Change Email
                </Text>
              </TouchableOpacity>
